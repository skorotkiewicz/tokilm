...
<p align="center">
  ...
  <a href="https://huggingface.co/datasets/NetherQuartz/tatoeba-tokipona"><img src="https://img.shields.io/badge/🤗_Dataset-tatoeba--tokipona-blue" alt="Dataset"/></a>&nbsp;
...
A ~9M parameter LLM trained from scratch that speaks and translates [Toki Pona](https://en.wikipedia.org/wiki/Toki_Pona).
...
- **Translations:** [NetherQuartz/tatoeba-tokipona](https://huggingface.co/datasets/NetherQuartz/tatoeba-tokipona) — multilingual pairs trained in both directions
- **Steps:** 10,000
- **Optimizer:** AdamW (cosine LR schedule)
- **Hardware:** T4 GPU (~5 min)
- **No system prompt** — translation uses compact language labels
...
r = engine.chat_completion([{"role": "user", "content": "English: I am happy.\nToki Pona:"}])
print(r["choices"][0]["message"]["content"])
```
...
- **Translations:** [huggingface.co/datasets/NetherQuartz/tatoeba-tokipona](https://huggingface.co/datasets/NetherQuartz/tatoeba-tokipona)
